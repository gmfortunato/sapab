                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Vencedor - Kina</th>
                                                <th class="text-center">Vencedor - Keno</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr style="cursor: pointer;" onclick="javascript:location.href='{{ route('admin.lotteries.show', ['faq' => $lottery->id])}}'">
                                                ...
                                                <td class="text-center">{{ $lottery->card_kina }}</td>
                                                <td class="text-center">{{ $lottery->card_keno }}</td>
